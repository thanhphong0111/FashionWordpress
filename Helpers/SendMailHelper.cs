...
namespace Group1_CourseOnline.Helpers
{
	public class SendMailHelper : Controller
	{
        public async static void SendMail(string email, string body)
        {
            ...
            using (var smtp = new SmtpClient())
            {
                ...
                {
                    UserName = "thanhphongyd2@gmail.com", 
                    Password = "wlecbpiswqcynzhj"
                };
                ...
                message.Subject = "Forgot Password BlueEdu";
                message.Body = body;
                message.IsBodyHtml = true;
                message.From = new MailAddress("thanhphongyd2@gmail.com");
